...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "size-full min-h-0 min-w-0 scroll-fade-b overflow-y-auto overscroll-contain contain-content [scrollbar-gutter:stable_both-edges] data-autoscrolling:[scrollbar-color:transparent_transparent]",
        className
      )}
      {...props}
    />
