...
| CR-R0 | `spec-run-contract-v2.md` | Ready for Review | AR2a 已 ship | 共享 Run/Task/Completion 类型 |
...
| CR-R1 | `spec-run-events-persistence-replay.md` | Blocked | CR-R0 | AR2b、run_events、checkpoint、replay |
| CR-Q1 | `spec-deliverable-quality-gate.md` | Blocked | CR-R0、CR-S1 | 通用 validator registry、不可变交付 |
